...
class WorkflowClassificationTests(unittest.TestCase):
    ...
    def test_validate_workflow_classification_reports_duplicate_root_after_top_level_key(self):
        markdown_text = (
            "```yaml\n"
            "workflow_classification:\n"
            "  implementation_complexity: low\n"
    ...
    def test_validate_workflow_classification_reports_duplicate_root_after_comment(self):
        markdown_text = (
            "```yaml\n"
            "workflow_classification:\n"
            "  implementation_complexity: low\n"
